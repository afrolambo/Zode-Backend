...
#     end 
    ...
    taurus = Zode.create(
        ...
        likes:  [" Phot ography", " the mountains"," great music"," rich/gourmet food"," satin sheets"],
    ...
    aquarius = Zode.create(
        ...
        good_traits: [ "Guarded"," detached"," self-destructive", " out-of-touch"," irrational", " desperate"],
        compatibility: ["Aries", " Gemini", " Libra", " Sagittarius"],
